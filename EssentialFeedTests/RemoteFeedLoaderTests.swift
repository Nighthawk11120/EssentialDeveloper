...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    private func makeSUT(url: URL = URL(string: "https://a-given-url.com")!, file: StaticString = #file, line: UInt = #line) -> (sut: RemoteFeedLoader, client: HTTPClientSpy) {
        ...
        trackForMemoryLeks(sut, file: file, line: line)
        trackForMemoryLeks(client, file: file, line: line)

        return (sut, client)
    }
    
    private func trackForMemoryLeks(_ instance: AnyObject, file: StaticString = #file, line: UInt = #line) {
